...
DROP TABLE IF EXISTS `pulseira_eventos`;
DROP TABLE IF EXISTS `pulseira_comandos`;
DROP TABLE IF EXISTS `pulseira_vinculos`;
...
CREATE TABLE `perfis_medicos` (
  ...
  `fuma` varchar(8) NOT NULL DEFAULT 'nao',
  `bebe` varchar(8) NOT NULL DEFAULT 'nao',
...
-- -----------------------------------------------------------------------------
-- pulseiras (tag física lida/escrita pelo Raspberry + PN532)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- pulseira_vinculos (qual ficha está vinculada à pulseira)
-- -----------------------------------------------------------------------------
CREATE TABLE `pulseira_vinculos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------------------------------
-- pulseira_comandos (fila AWS -> Raspberry)
-- -----------------------------------------------------------------------------
CREATE TABLE `pulseira_comandos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------------------------------
-- pulseira_eventos (auditoria detalhada das operações)
-- -----------------------------------------------------------------------------
CREATE TABLE `pulseira_eventos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pulseira_id` int(11) DEFAULT NULL,
