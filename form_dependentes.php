    ...
    <div class="form-container">
        ...
        <form id="dependenteForm" action="registrar_dependente.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-step active" id="step1" data-step="1">
                ...
                <?php
                    $cep_valor = $dados_form['cep'] ?? $perfil_dependente['cep'] ?? '';
                    $rua_valor = $dados_form['rua'] ?? $perfil_dependente['rua'] ?? '';
                    $numero_valor = $dados_form['numero'] ?? $perfil_dependente['numero'] ?? '';
                    $complemento_valor = $dados_form['complemento'] ?? $perfil_dependente['complemento'] ?? '';
                    $bairro_valor = $dados_form['bairro'] ?? $perfil_dependente['bairro'] ?? '';
                    $cidade_valor = $dados_form['cidade'] ?? $perfil_dependente['cidade'] ?? '';
                    $estado_valor = $dados_form['estado'] ?? $perfil_dependente['estado'] ?? '';
                ?>

                <label for="cep">CEP</label>
                <input type="text" id="cep" name="cep" placeholder="Digite o CEP" value="<?= htmlspecialchars($cep_valor) ?>">

                <label for="rua">Rua</label>
                <input type="text" id="rua" name="rua" placeholder="Digite o nome da rua" value="<?= htmlspecialchars($rua_valor) ?>">

                <label for="numero">Número</label>
                <input type="text" id="numero" name="numero" placeholder="Digite o número" value="<?= htmlspecialchars($numero_valor) ?>">

                <label for="complemento">Complemento</label>
                <input type="text" id="complemento" name="complemento" placeholder="Digite o complemento" value="<?= htmlspecialchars($complemento_valor) ?>">

                <label for="bairro">Bairro</label>
                <input type="text" id="bairro" name="bairro" placeholder="Digite o bairro" value="<?= htmlspecialchars($bairro_valor) ?>">

                <label for="cidade">Cidade</label>
                <input type="text" id="cidade" name="cidade" placeholder="Digite a cidade" value="<?= htmlspecialchars($cidade_valor) ?>">

                <label for="estado">Estado</label>
                <input type="text" id="estado" name="estado" placeholder="Digite o estado" value="<?= htmlspecialchars($estado_valor) ?>">
            ...
            <div class="form-step" id="step3" data-step="3">
                ...
                $fuma_selecionado = $dados_form['fuma'] ?? $perfil_dependente['fuma'] ?? '';
                $bebe_selecionado = $dados_form['bebe'] ?? $perfil_dependente['bebe'] ?? '';
                ?>
                ...
                <select id="fuma" name="fuma">
                    <option value="">Selecione</option>
                    <option value="sim" <?= $fuma_selecionado === 'sim' ? 'selected' : '' ?>>Sim</option>
                    <option value="nao" <?= $fuma_selecionado === 'nao' ? 'selected' : '' ?>>Não</option>
                </select>

                <label for="bebe">Consome álcool?</label>
                <select id="bebe" name="bebe">
                    <option value="">Selecione</option>
                    <option value="sim" <?= $bebe_selecionado === 'sim' ? 'selected' : '' ?>>Sim</option>
                    <option value="nao" <?= $bebe_selecionado === 'nao' ? 'selected' : '' ?>>Não</option>
                </select>
