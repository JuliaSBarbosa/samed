    ...
    <div class="form-container">
        ...
        <form id="perfilForm" action="salvar_perfil.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-step active" id="step1" data-step="1">
                ...
                <?php
                    $cep_valor = $dados_form['cep'] ?? $perfil['cep'] ?? '';
                    $rua_valor = $dados_form['rua'] ?? $perfil['rua'] ?? '';
                    $numero_valor = $dados_form['numero'] ?? $perfil['numero'] ?? '';
                    $complemento_valor = $dados_form['complemento'] ?? $perfil['complemento'] ?? '';
                    $bairro_valor = $dados_form['bairro'] ?? $perfil['bairro'] ?? '';
                    $cidade_valor = $dados_form['cidade'] ?? $perfil['cidade'] ?? '';
                    $estado_valor = $dados_form['estado'] ?? $perfil['estado'] ?? '';
                ?>
            ...
            <div class="form-step" id="step3" data-step="3">
                ...
                $fuma_selecionado = $dados_form['fuma'] ?? $perfil['fuma'] ?? '';
                $bebe_selecionado = $dados_form['bebe'] ?? $perfil['bebe'] ?? '';
                ?>
